...
<body id="frame_body">
    ...
    <div id="content" class="playground">
        <iframe id="intro" src="https://player.vimeo.com/video/153895401?autoplay=0&title=0&byline=0&portrait=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        ...
        <div id="text">
            <div id="introduction">
                <?php 
                        ...
                        echo $playground['title'];
                        echo "&#46;&nbsp;";
                        echo $playground['subtitle'];
                        echo "</span>&nbsp;";
                        echo $playground['introduction'];
                        echo "<br><br>";
                ?>
            </div>
